...
Example of html self-contained with __rgee package__ (Google Earth Engine) for February 2022 fires of Corrientes Province (Argentina) with an interactive map. In red soil fire scars and some of the smoke columns. Several layers options, scroll in - out.<br>
